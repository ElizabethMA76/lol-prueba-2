...
import 'schema/campeones_record.dart';
...
export 'schema/campeones_record.dart';
...
/// Functions to query CampeonesRecords (as a Stream and as a Future).
Future<int> queryCampeonesRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      CampeonesRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<CampeonesRecord>> queryCampeonesRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      CampeonesRecord.collection,
      CampeonesRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<CampeonesRecord>> queryCampeonesRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
